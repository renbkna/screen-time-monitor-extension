...
describe('PopupManager', () => {
  ...
  describe('tab switching', () => {
    ...
    it('should update active tab styling', () => {
      ...
      expect(document.querySelector('[data-tab="dashboard"]').classList.contains('active')).toBeFalsy();
    });
  });
  ...
  describe('current site info', () => {
    ...
    it('should handle quick limit button clicks', async () => {
      ...
      expect(document.querySelector('#limits-container').classList.contains('hidden')).toBeFalsy();
